...
{
    /**
     * Path to store config where count of contact posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'contact/view/items_per_page';
    ...
    /**
     * Remove Contact item image by image filename
     *
    ...
    /**
     * Return URL for resized Contact Item Image
     *
     * @param Lts\Contact\Model\Contact $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(\Lts\Contact\Model\Contact $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Contact Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Contact Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getContactPerPage()
    {
